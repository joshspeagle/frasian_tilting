...
posterior under `NormalNormalModel`. It is a dataclass conforming to
the protocols in `models.base`. All density/log-density/cdf paths return
...
class MixtureDistribution:
    ...
    distribution is not Gaussian (it is then represented as a
    `GridDistribution`).
