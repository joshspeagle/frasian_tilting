...
from frasian.tilting._admissible import (
    ...
    make_default_validity_fn,
    numerical_admissible_range,
...
def test_numerical_recovers_real_bounds_powerlaw(w_val):
    ...
    assert eta_high < eta_high_closed, (
        f"η_high={eta_high} ≥ closed-form variance-positivity upper " f"bound {eta_high_closed}"
    )
    assert (
        eta_high > eta_high_closed - 0.1
